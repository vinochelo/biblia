...
const februaryPlan: Reading[] = [
    { month: 2, day: 1, passages: ["Hechos 4", "Génesis 25", "Proverbios 6"] },
    { month: 2, day: 2, passages: ["Hechos 5", "Génesis 26, 27"] },
    { month: 2, day: 3, passages: ["Hechos 6", "Génesis 28", "Salmos 14"] },
    { month: 2, day: 4, passages: ["Hechos 7", "Génesis 29, 30"] },
    { month: 2, day: 5, passages: ["Hechos 8", "Génesis 31", "Salmos 15"] },
    { month: 2, day: 6, passages: ["Hechos 9", "Génesis 32, 33"] },
    { month: 2, day: 7, passages: ["Hechos 10", "Génesis 34, 35", "Salmos 16"] },
    { month: 2, day: 8, passages: ["Hechos 11", "Génesis 36"] },
    { month: 2, day: 9, passages: ["Hechos 12", "Génesis 37, 38", "Salmos 17"] },
    { month: 2, day: 10, passages: ["Hechos 13", "Génesis 39, 40"] },
    { month: 2, day: 11, passages: ["Hechos 14", "Génesis 41", "Proverbios 7"] },
    { month: 2, day: 12, passages: ["Hechos 15", "Génesis 42, 43"] },
    { month: 2, day: 13, passages: ["Hechos 16", "Génesis 44, 45", "Salmos 18"] },
    { month: 2, day: 14, passages: ["Hechos 17", "Génesis 46, 47"] },
    { month: 2, day: 15, passages: ["Hechos 18", "Génesis 48, 49, 50", "Proverbios 8"] },
    { month: 2, day: 16, passages: ["Hechos 19", "Éxodo 1, 2"] },
    { month: 2, day: 17, passages: ["Hechos 20", "Éxodo 3, 4", "Salmos 19"] },
    { month: 2, day: 18, passages: ["Hechos 21", "Éxodo 5, 6"] },
    { month: 2, day: 19, passages: ["Hechos 22", "Éxodo 7, 8", "Salmos 20"] },
    { month: 2, day: 20, passages: ["Hechos 23", "Éxodo 9, 10"] },
    { month: 2, day: 21, passages: ["Hechos 24", "Éxodo 11, 12", "Salmos 21"] },
    { month: 2, day: 22, passages: ["Hechos 25", "Éxodo 13, 14"] },
    { month: 2, day: 23, passages: ["Hechos 26", "Éxodo 15", "Proverbios 9"] },
    { month: 2, day: 24, passages: ["Hechos 27", "Éxodo 16, 17"] },
    { month: 2, day: 25, passages: ["Hechos 28", "Éxodo 18, 19", "Salmos 22"] },
    { month: 2, day: 26, passages: ["Marcos 1", "Éxodo 20, 21", "Salmos 23"] },
    { month: 2, day: 27, passages: ["Marcos 2", "Éxodo 22, 23"] },
    { month: 2, day: 28, passages: ["Marcos 3", "Éxodo 24, 25", "Proverbios 10"] }
];
